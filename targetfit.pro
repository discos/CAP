pro targetresiduals, X,Y,datafit,Unit2,peak,err, x_peak, rasd, decsd, tipo, SNR, peak_cnt, err_cnt, Level, n_off, off, residual
...
pro getflux, peak_cnt, err_cnt, tau0, datael, cnt2Jy, err_cnt2Jy, outflux, err_outflux, Unit2, Level
  
  ; Minor section to computate flux density (application of cnt2jy factor)
  ...
  Level=Level*cnt2Jy
  PRINTF, Unit2, " "
  PRINTF, Unit2, "outflux = (", outflux, "+-", err_outflux, ") [Jy]"
  PRINTF, Unit2, " "
  PRINTF, Unit2, "Level = ", Level, " [Jy]" 
  PRINTF, Unit2, " "
  return
end
...
;      print, 'Sigma     =',A_sig
      ...
      targetresiduals, X,Y,datafit,Out3,A_fit[0],A_sig[0], x_peak, rasd, decsd, tipo, SNR, peak_cnt, err_cnt, Level, n_off, off, residual
      ...
      err_cnt=sqrt(err_cnt^2+res_rms^2)  ; updated error for the amplitude measurement
      
      getflux, peak_cnt, err_cnt, tau0, datael, cnt2Jy, err_cnt2Jy, outflux, err_outflux, Out3, Level
      ...
      datafit = CURVEFIT(X,Y,DUM_W, A, SIGMA, FITA=[1,1,1,1,1,1,1], FUNCTION_NAME='tar_gfunct', /DOUBLE, STATUS=suc_fit)
...
;      print, 'Sigma parameters:    ', SIGMA
      ...
      targetresiduals, X,Y,datafit,Out3,A[0],A[2], x_peak, rasd, decsd, tipo, SNR, peak_cnt, err_cnt, Level, n_off, off, residual
